...
<div class="container mt-3">
    ...
    <div class="admin-table-card p-4 mb-4 shadow-sm rounded border-0">
        <h6 class="fw-bold text-secondary mb-3"><i class="bi bi-person-lines-fill me-2"></i>اطلاعات کاربری</h6>
    ...
    <div class="admin-table-card p-4 shadow-sm rounded border-0">
        <h6 class="fw-bold text-secondary mb-3"><i class="bi bi-shield-lock me-2"></i>تغییر رمز عبور</h6>
