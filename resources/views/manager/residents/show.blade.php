...
<div class="container mt-3">
    ...
    <div class="admin-table-card p-4"> <!-- اضافه کردن padding به کادر اصلی -->
        {{-- اطلاعات شخصی --}}
            ...
            <div class="w-100">
                ...
                <div class="d-flex flex-wrap gap-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="value">{{ $unitUser->unit->building->building_name ?? '—' }}</span>
                    </div>
                    <div class="d-flex align-items-center">
            ...
            <div class="w-100">
                ...
                <div class="d-flex flex-wrap gap-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="value">{{ $unitUser->to_date ? jdate($unitUser->to_date)->format('Y/m/d') : 'نامشخص' }}</span>
                    </div>
                </div>
            </div>
        </div>
