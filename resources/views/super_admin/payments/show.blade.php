...
<div class="container mt-3">
    <div class="admin-header d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('superadmin.payments.receipt', $payment->id) }}" target="_blank" class="btn btn-outline-secondary">
            <i class="bi bi-printer me-1"></i>چاپ رسید
        </a>
        <a href="{{ route('superadmin.payments.index') }}" class="btn filter-btn">
