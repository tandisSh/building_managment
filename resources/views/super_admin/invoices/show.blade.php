...
<div class="container mt-3">
    <div class="admin-header d-flex justify-content-between align-items-center mb-4">
        <h6 class="mb-0 fw-bold text-white">
            <i class="bi bi-receipt me-2"></i>جزئیات صورتحساب واحد {{ $invoice->unit->unit_number }}
        </h6>
        <a href="{{ route('superadmin.invoices.index') }}" class="btn filter-btn">
        ...
        <div class="compact-info-card mb-4 mx-3">
            ...
            <div class="w-100">
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="label me-3">ساختمان:</span>
                        <span class="value">{{ $invoice->unit->building->name ?? '-' }}</span>
                    </div>
                </div>
            </div>
        </div>
